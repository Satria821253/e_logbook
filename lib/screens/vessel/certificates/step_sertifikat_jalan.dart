...
class _StepSertifikatJalanState extends State<StepSertifikatJalan> {
  ...
  Future<void> _submit() async {
    if (_namaController.text.trim().isEmpty) {
      _showSnackBar('Nama sertifikat wajib diisi', Colors.orange);
      return;
    }
    if (_nomorController.text.trim().isEmpty) {
      _showSnackBar('Nomor sertifikat wajib diisi', Colors.orange);
      return;
    }
    ...
    if (_filePath == null) {
      _showSnackBar('File wajib diupload', Colors.orange);
      return;
    }
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: 'Contoh: Sertifikat Jalan 2024',
              prefixIcon: Padding(
                padding: EdgeInsets.all(12),
                child: Container(
                  padding: EdgeInsets.all(8),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 12),
                  Expanded(child: Text(_fileName ?? '', style: TextStyle(fontSize: 14))),
                  IconButton(
