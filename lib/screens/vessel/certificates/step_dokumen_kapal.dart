...
class StepDokumenKapal extends StatefulWidget {
  final int? tripId;
  final VoidCallback onNext;

  const StepDokumenKapal({Key? key, this.tripId, required this.onNext}) : super(key: key);

  @override
  State<StepDokumenKapal> createState() => _StepDokumenKapalState();
}

class _StepDokumenKapalState extends State<StepDokumenKapal> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      print('========== UPLOAD DOKUMEN KAPAL END ==========\n');

      _showSnackBar(
        response['message'] ?? 'Berhasil upload Dokumen Kapal!', 
        Colors.green,
      );
      widget.onNext();
    } catch (e) {
      print('❌ [UPLOAD DOKUMEN KAPAL] ERROR: $e\n');
      _showSnackBar(
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Dokumen Kapal', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF1B4F9C))),
                        SizedBox(height: 2),
                        Text('SIUP, SIPI, Sertifikat Jalan, dll', style: TextStyle(fontSize: 11, color: Colors.grey[600])),
                      ],
                    ),
                  ),
                ],
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Contoh: Sertifikat jalan berlaku sampai 31 Des 2026',
                prefixIcon: Padding(
                  padding: EdgeInsets.all(12),
                  child: Container(
                    padding: EdgeInsets.all(8),
