...
class _ActiveTrackingScreenState extends State<ActiveTrackingScreen> {
  ...
  Future<void> _stopTracking() async {
    ...
    print('🛑 [ActiveTracking] User confirmed stop tracking');
    
    // Stop tracking service dan cleanup semua resources
    ...
    // Stop tracking di provider
    _minimizeProvider?.stopTracking();
