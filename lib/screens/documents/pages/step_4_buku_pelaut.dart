// lib/screens/document_upload/pages/step_4_buku_pelaut.dart
...
class Step4BukuPelaut extends StatefulWidget {
  final VoidCallback onNext;

  const Step4BukuPelaut({Key? key, required this.onNext}) : super(key: key);

  @override
  State<Step4BukuPelaut> createState() => _Step4BukuPelautState();
}

class _Step4BukuPelautState extends State<Step4BukuPelaut> {
  File? _selectedFile;
      ...
      if (mounted) {
        if (result['success'] == true) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Buku Pelaut berhasil diupload!'), backgroundColor: Colors.green),
          );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        '• Semua halaman harus difoto\n'
                        '• Pastikan nomor dan tanggal jelas',
                        style: TextStyle(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Masukkan nomor buku pelaut',
                      ...
                      Expanded(
                        child: Text(
                          _tanggalBerlaku == null
                              ...
                              : DateFormat('dd MMMM yyyy').format(_tanggalBerlaku!),
                          style: TextStyle(
                            fontSize: 15,
                            color: _tanggalBerlaku == null
                                ? Colors.grey[600]
                                : Colors.black87,
                          ),
                        ),
